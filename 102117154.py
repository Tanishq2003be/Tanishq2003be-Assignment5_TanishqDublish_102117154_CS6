...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Download and create a mashup of YouTube videos.')
    parser.add_argument('singer_name', type=str, help='Name of the singer')
    parser.add_argument('num_videos', type=int,
                        help='Number of videos to download')
    parser.add_argument('audio_duration', type=int,
    ...
    api_key = 'AIzaSyAJq5t7IavGMSQQTuUdOtaYjMh4lO4Lzp0'
    mashup(api_key, args.singer_name, args.num_videos,
           args.audio_duration, args.output_filename)
